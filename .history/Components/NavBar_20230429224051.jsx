              ...
              <ul class="items-center hidden space-x-8 lg:flex">
                <li class="inline-block">
                  <button 
                    ...
                    tracking-wide text-white transition duration-200 rounded-xl motion-reduce:animate-ping hover:animate-pulse shadow-md
                    bg-teal-500 hover:bg-orange-300 focus:shadow-outline focus:outline-none"
                    aria-label="sign up"
                  >
                    Connect Wallet
                  </button>
                          ...
                          <ul class="space-y-4">
                            ...
                            <li>
                              <a
                                ...
                                title="Sign up"
                                class="inline-flex items-center justify-center h-12 px-6 font-medium
                                tracking-wide text-white transition duration-200 rounded-xl shadow-md
                                bg-teal-500 hover:bg-orange-300 focus:shadow-outline focus:outline-none"
                              >
                                Connect Wallet
                              </a>
