  ...
  return (
    <footer class="text-center text-white backgroundMain lg:text-left" >
      <div class="container p-4 pb-0 mx-auto mt-5">
        <div class="flex flex-wrap justify-center">
          <div class="w-full px-4 lg:w-1/4 md:w-1/2">
            <h5 class="mb-4 items-center font-bold text-white">Products</h5>
          ...
          <div class="w-full px-4 lg:w-1/4 md:w-1/2">
            <h5 class="mb-4 items-center uppercase font-bold text-white">Useful Links</h5>
            <ul class="mb-4 text-white">
      ...
      <div class="flex justify-center py-4 lg:pt-4 border-t border-gray-800">
        <div class="flex flex-wrap justify-center">
          <div class="w-full px-4 lg:w-1/4 md:w-1/2">
            <h5 class="mb-4 items-center font-bold text-white">Contact Us</h5>
            <ul class="mb-4 text-white">
